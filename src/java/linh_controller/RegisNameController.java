 ...
 * @author nguye
 */
@WebServlet(name = "RegisNameController", urlPatterns = {"/RegisNameController"})
public class RegisNameController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String code = request.getParameter("codeMail");
